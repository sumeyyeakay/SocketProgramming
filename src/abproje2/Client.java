...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fotoğraf", "Dosya" }));
        ...
        mesaj.setColumns(20);
        mesaj.setRows(5);
        mesaj.setText("Mesajınızı girin.");
        jScrollPane2.setViewportView(mesaj);
